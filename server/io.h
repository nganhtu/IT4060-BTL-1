...
/**
* The mark_directory function create the last folder of the path
* @param	dir		is the path of folder
* @return	0		if create is okey
* @return	-1		if the folder is exists or not done
*/
...
/**
* The getFileNames function get all name of the files is the children in the folder_path
* @param	folder_path		the folder path
* @param	file_names			contains file names after the function is called
*/
int getFileNames(const string folder_path, string &file_names)
{
	file_names.clear();
	WIN32_FIND_DATA data;
	memset(&data, -1, sizeof data);
	//find first file
	wchar_t wfolder_path[260];
	toWchar_t(folder_path + "*.*", wfolder_path, sizeof wfolder_path);
	HANDLE hFile = FindFirstFile(wfolder_path, &data);
	do
	{
