...
int getCagegaryAndAddress(char *mess, int mess_len, string &categary, string &address) {
	if (mess_len < 6 || mess[4] != ' ') {
		return 0;
	}
	int separation = mess_len;
...
int getUsernameAndCagegaryAndAddress(char *mess, int mess_len, string &username, string &categary, string &address) {
	if (mess_len < 6 || mess[4] != ' ') {
		return 0;
	}
